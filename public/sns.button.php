<div style="float:right;padding-left:10px;">
	<div style="position:relative;">
		...
		<div class="share-container" style="line-height:10px;width:150px;padding:10px;position:absolute;display:none;margin-top:-10px;background:white;right:0px;border:1px solid #ddd;">
        ...
        <div class="share-link" style='margin-top:5px'>
            <label style="margin:5px;">Share Link<label>
            <div><input type='text' class='input'  style='width:150px' value='<?php echo urldecode($share_url) ?>' /> </div>
        </div>
        <div class="embed-link" style='margin-top:5px'>
            <label style="margin:5px">Embed Link<label>
            <div><input type='text' class='input' style='width:150px' value='<iframe src="<?php echo $embed_url ?>" width="100%" height="400px"></iframe>'/> </div>
        </div>
        </div>
	</div>
</div>
