<div style="float:right;padding-left:10px;">
	<div style="position:relative;">
		<a class="share-button" onclick="toggleSns(this)" style="cursor:pointer"><i class=""></i> Share</a>
		<div class="share-buttons" style="line-height:10px;width:150px;padding:10px;position:absolute;display:none;margin-top:-10px;background:white;right:0px;border:1px solid #ddd;">
